<?php
session_start();
if(!isset($_SESSION['S_IDUSER'])){//Si NO existe una sesion de usuario
  header('Location: ../Ppal/index.php');//Redirecciona al login 
}
?>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../Vista/index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Sistema BQ</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" onclick="cargar_contenido('contenido_principal','Usuario/mantenimiento_bq.php')">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" onclick="cargar_contenido('contenido_principal','Usuario/mantenimiento_med.php')">
